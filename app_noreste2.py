...
def run():
    st.write("Aquí va la lógica para la estación Noreste 2")

    columnas = [
        "CO_noreste2", "NO_noreste2", "NO2_noreste2", "NOX_noreste2", "O3_noreste2", "PM10_noreste2", "PM2.5_noreste2", 
        "SO2_noreste2"
    ]
    ...
    if componente_estacion:
        ...
        if componente_estacion in df.columns:
            ...
            modelo_path = f'models/noreste2/{componente_estacion}.pkl'
