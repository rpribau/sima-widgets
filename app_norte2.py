...
def run():
    st.write("Aquí va la lógica para la estación Norte 2")

    columnas = [
        "CO_norte2", "NO_norte2", "NO2_norte2", "NOX_norte2", "O3_norte2", "PM10_norte2", "PM2.5_norte2", 
        "SO2_norte2"
    ]
    ...
    if componente_estacion:
        ...
        if componente_estacion in df.columns:
            ...
            modelo_path = f'models/norte2/{componente_estacion}.pkl'
