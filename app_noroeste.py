...
def run():
    st.write("Aquí va la lógica para la estación Noroeste")

    columnas = [
        "CO_noroeste", "NO_noroeste", "NO2_noroeste", "NOX_noroeste", "O3_noroeste", "PM10_noroeste", "PM2.5_noroeste", 
        "SO2_noroeste"
    ]
    ...
    if componente_estacion:
        ...
        if componente_estacion in df.columns:
            ...
            modelo_path = f'models/noroeste/{componente_estacion}.pkl'
