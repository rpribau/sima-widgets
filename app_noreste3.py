...
def run():
    st.write("Aquí va la lógica para la estación Noreste 3")

    columnas = [
        "CO_noreste3", "NO_noreste3", "NO2_noreste3", "NOX_noreste3", "O3_noreste3", "PM10_noreste3", "PM2.5_noreste3", 
        "SO2_noreste3"
    ]
    ...
    if componente_estacion:
        ...
        if componente_estacion in df.columns:
            ...
            modelo_path = f'models/noreste3/{componente_estacion}.pkl'
