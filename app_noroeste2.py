...
def run():
    st.write("Aquí va la lógica para la estación noroeste_2")

    columnas = [
        "CO_noroeste2", "NO_noroeste2", "NO2_noroeste2", "NOX_noroeste2", "O3_noroeste2", "PM10_noroeste2", "PM2.5_noroeste2", 
        "SO2_noroeste2"
    ]
    ...
    if componente_estacion:
        ...
        if componente_estacion in df.columns:
            ...
            modelo_path = f'models/noroeste2/{componente_estacion}.pkl'
