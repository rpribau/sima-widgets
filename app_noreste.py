...
def run():
    st.write("Aquí va la lógica para la estación Noreste")

    columnas = [
        "CO_noreste", "NO_noreste", "NO2_noreste", "NOX_noreste", "O3_noreste", "PM10_noreste", "PM2.5_noreste", 
        "SO2_noreste"
    ]
    ...
    if componente_estacion:
        ...
        if componente_estacion in df.columns:
            ...
            modelo_path = f'models/noreste/{componente_estacion}.pkl'
